...
HD_PWD='c:/users/neastbur/cpre488/mps/mp-0/ip_repo/edit_snes_controller_reader_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log snes_controller_reader_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source snes_controller_reader_v1_0.tcl -notrace
