...
void Map135_Apu(word wAddr, byte byData) {
  ...
  case 0x4101:
    ...
    case 5:
      /* Set ROM Banks */
      W.ROMBANK0 =
          ROMPAGE((((byData % 0x07) << 2) + 0) % (S.NesHeader.ROMSize << 1));
      W.ROMBANK1 =
          ROMPAGE((((byData % 0x07) << 2) + 1) % (S.NesHeader.ROMSize << 1));
      W.ROMBANK2 =
          ROMPAGE((((byData % 0x07) << 2) + 2) % (S.NesHeader.ROMSize << 1));
      W.ROMBANK3 =
          ROMPAGE((((byData % 0x07) << 2) + 3) % (S.NesHeader.ROMSize << 1));
      break;
    case 6:
      break;
    case 7:
...
void Map135_Set_PPU_Banks() {
  /* Set PPU Banks */
  W.PPUBANK[0] =
      VROMPAGE((((0 | (Map135_Chr0l << 1) | (Map135_Chrch << 4)) << 1) + 0) %
               (S.NesHeader.VROMSize << 3));
  W.PPUBANK[1] =
      VROMPAGE((((0 | (Map135_Chr0l << 1) | (Map135_Chrch << 4)) << 1) + 1) %
               (S.NesHeader.VROMSize << 3));
  W.PPUBANK[2] =
      VROMPAGE((((1 | (Map135_Chr0h << 1) | (Map135_Chrch << 4)) << 1) + 0) %
               (S.NesHeader.VROMSize << 3));
  W.PPUBANK[3] =
      VROMPAGE((((1 | (Map135_Chr0h << 1) | (Map135_Chrch << 4)) << 1) + 1) %
               (S.NesHeader.VROMSize << 3));
  W.PPUBANK[4] =
      VROMPAGE((((0 | (Map135_Chr1l << 1) | (Map135_Chrch << 4)) << 1) + 0) %
               (S.NesHeader.VROMSize << 3));
  W.PPUBANK[5] =
      VROMPAGE((((0 | (Map135_Chr1l << 1) | (Map135_Chrch << 4)) << 1) + 1) %
               (S.NesHeader.VROMSize << 3));
  W.PPUBANK[6] =
      VROMPAGE((((1 | (Map135_Chr1h << 1) | (Map135_Chrch << 4)) << 1) + 0) %
               (S.NesHeader.VROMSize << 3));
  W.PPUBANK[7] =
      VROMPAGE((((1 | (Map135_Chr1h << 1) | (Map135_Chrch << 4)) << 1) + 1) %
               (S.NesHeader.VROMSize << 3));
