...
void Map115_Init() {
  ...
  if (S.NesHeader.VROMSize > 0) {
    ...
    Map115_Chr0 = Map115_Chr2 = Map115_Chr4 = Map115_Chr5 = Map115_Chr6 =
        Map115_Chr7 = 0;
...
void Map115_Set_PPU_Banks() {
  if (S.NesHeader.VROMSize > 0) {
    if (Map115_Reg[0] & 0x80) {
      W.PPUBANK[0] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr4) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[1] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr5) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[2] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr6) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[3] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr7) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[4] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr0) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[5] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr1) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[6] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr2) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[7] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr3) %
                              (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
    } else {
      W.PPUBANK[0] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr0) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[1] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr1) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[2] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr2) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[3] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr3) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[4] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr4) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[5] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr5) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[6] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr6) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[7] = VROMPAGE(((Map115_ExChrSwitch << 8) + Map115_Chr7) %
                              (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
    }
  }
