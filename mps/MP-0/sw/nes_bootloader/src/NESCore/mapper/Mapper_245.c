...
byte Map245_Chr01, Map245_Chr23, Map245_Chr4, Map245_Chr5, Map245_Chr6,
    Map245_Chr7;
byte Map245_WeSram;
...
void Map245_Write(word wAddr, byte byData) {
  ...
  case 0x8001:
    ...
    W.ROMBANK0 =
        ROMPAGE((Map245_Prg0 | Map245_Reg[3]) % (S.NesHeader.ROMSize << 1));
    W.ROMBANK1 =
        ROMPAGE((Map245_Prg1 | Map245_Reg[3]) % (S.NesHeader.ROMSize << 1));
    break;
  case 0xA000:
    Map245_Reg[2] = byData;
    if (!S.ROM_FourScr) {
