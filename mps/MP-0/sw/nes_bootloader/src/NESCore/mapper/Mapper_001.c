...
enum Map1_Size_t { Map1_SMALL, Map1_512K, Map1_1024K };
...
void Map1_set_ROM_banks() {
  ...
  W.ROMBANK0 = ROMPAGE(((MS1.Map1_256k_base << 5) + (MS1.Map1_bank1 & (31))) %
                       (S.NesHeader.ROMSize << 1));
  W.ROMBANK1 = ROMPAGE(((MS1.Map1_256k_base << 5) + (MS1.Map1_bank2 & (31))) %
                       (S.NesHeader.ROMSize << 1));
  W.ROMBANK2 = ROMPAGE(((MS1.Map1_256k_base << 5) + (MS1.Map1_bank3 & (31))) %
                       (S.NesHeader.ROMSize << 1));
  W.ROMBANK3 = ROMPAGE(((MS1.Map1_256k_base << 5) + (MS1.Map1_bank4 & (31))) %
                       (S.NesHeader.ROMSize << 1));
}
...
void Map1_Write(word wAddr, byte bData) {
  ...
  /*
    This doesn't make sense. We don't want to reset if the write address
    changes, we just write to the last address provided.
...
void Map1_Restore() { Map1_set_ROM_banks(); }
