...
void Map90_Sync_Mirror(void) {
  ...
  for (byPage = 0; byPage < 4; byPage++) {
    dwNamBank[byPage] = ((dword)Map90_Nam_High_Reg[byPage] << 8) |
                        (dword)Map90_Nam_Low_Reg[byPage];
  }

  if (Map90_Mirror_Mode) {
    for (byPage = 0; byPage < 4; byPage++) {
      if (!Map90_Nam_High_Reg[byPage] &&
          (Map90_Nam_Low_Reg[byPage] == byPage)) {
        Map90_Mirror_Mode = 0;
      }
    }

    if (Map90_Mirror_Mode) {
      W.PPUBANK[NAME_TABLE0] =
          VROMPAGE(dwNamBank[0] % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[NAME_TABLE1] =
          VROMPAGE(dwNamBank[1] % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[NAME_TABLE2] =
          VROMPAGE(dwNamBank[2] % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[NAME_TABLE3] =
          VROMPAGE(dwNamBank[3] % (S.NesHeader.VROMSize << 3));
    }
  } else {
...
void Map90_Sync_Chr_Banks(void) {
  ...
  for (byPage = 0; byPage < 8; byPage++) {
    dwChrBank[byPage] = ((dword)Map90_Chr_High_Reg[byPage] << 8) |
                        (dword)Map90_Chr_Low_Reg[byPage];
  }

  switch (Map90_Chr_Bank_Size) {
  case 0:
    W.PPUBANK[0] =
        VROMPAGE(((dwChrBank[0] << 3) + 0) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[1] =
        VROMPAGE(((dwChrBank[0] << 3) + 1) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[2] =
        VROMPAGE(((dwChrBank[0] << 3) + 2) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[3] =
        VROMPAGE(((dwChrBank[0] << 3) + 3) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[4] =
        VROMPAGE(((dwChrBank[0] << 3) + 4) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[5] =
        VROMPAGE(((dwChrBank[0] << 3) + 5) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[6] =
        VROMPAGE(((dwChrBank[0] << 3) + 6) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[7] =
        VROMPAGE(((dwChrBank[0] << 3) + 7) % (S.NesHeader.VROMSize << 3));
    NESCore_Develop_Character_Data();
    break;

  case 1:
    W.PPUBANK[0] =
        VROMPAGE(((dwChrBank[0] << 2) + 0) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[1] =
        VROMPAGE(((dwChrBank[0] << 2) + 1) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[2] =
        VROMPAGE(((dwChrBank[0] << 2) + 2) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[3] =
        VROMPAGE(((dwChrBank[0] << 2) + 3) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[4] =
        VROMPAGE(((dwChrBank[4] << 2) + 0) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[5] =
        VROMPAGE(((dwChrBank[4] << 2) + 1) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[6] =
        VROMPAGE(((dwChrBank[4] << 2) + 2) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[7] =
        VROMPAGE(((dwChrBank[4] << 2) + 3) % (S.NesHeader.VROMSize << 3));
    NESCore_Develop_Character_Data();
    break;

  case 2:
    W.PPUBANK[0] =
        VROMPAGE(((dwChrBank[0] << 1) + 0) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[1] =
        VROMPAGE(((dwChrBank[0] << 1) + 1) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[2] =
        VROMPAGE(((dwChrBank[2] << 1) + 0) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[3] =
        VROMPAGE(((dwChrBank[2] << 1) + 1) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[4] =
        VROMPAGE(((dwChrBank[4] << 1) + 0) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[5] =
        VROMPAGE(((dwChrBank[4] << 1) + 1) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[6] =
        VROMPAGE(((dwChrBank[6] << 1) + 0) % (S.NesHeader.VROMSize << 3));
    W.PPUBANK[7] =
        VROMPAGE(((dwChrBank[6] << 1) + 1) % (S.NesHeader.VROMSize << 3));
    NESCore_Develop_Character_Data();
    break;
...
void Map90_Sync_Prg_Banks(void) {
  ...
  case 1:
    W.ROMBANK0 =
        ROMPAGE(((Map90_Prg_Reg[1] << 1) + 0) % (S.NesHeader.ROMSize << 1));
    W.ROMBANK1 =
        ROMPAGE(((Map90_Prg_Reg[1] << 1) + 1) % (S.NesHeader.ROMSize << 1));
    W.ROMBANK2 = ROMLASTPAGE(1);
    W.ROMBANK3 = ROMLASTPAGE(0);
    break;
