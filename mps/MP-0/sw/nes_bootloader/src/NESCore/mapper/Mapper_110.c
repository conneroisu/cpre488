...
void Map110_Apu(word wAddr, byte byData) {
  ...
  case 0x4101:
    ...
    case 0:
      ...
      W.PPUBANK[0] =
          VROMPAGE(((Map110_Reg0 << 3) + 0) % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[1] =
          VROMPAGE(((Map110_Reg0 << 3) + 1) % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[2] =
          VROMPAGE(((Map110_Reg0 << 3) + 2) % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[3] =
          VROMPAGE(((Map110_Reg0 << 3) + 3) % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[4] =
          VROMPAGE(((Map110_Reg0 << 3) + 4) % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[5] =
          VROMPAGE(((Map110_Reg0 << 3) + 5) % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[6] =
          VROMPAGE(((Map110_Reg0 << 3) + 6) % (S.NesHeader.VROMSize << 3));
      W.PPUBANK[7] =
          VROMPAGE(((Map110_Reg0 << 3) + 7) % (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
      break;
