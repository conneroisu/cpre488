...
void Map232_Write(word wAddr, byte byData) {
  ...
  W.ROMBANK0 = ROMPAGE((((Map232_Regs[0] | Map232_Regs[1]) << 1) + 0) %
                       (S.NesHeader.ROMSize << 1));
  W.ROMBANK1 = ROMPAGE((((Map232_Regs[0] | Map232_Regs[1]) << 1) + 1) %
                       (S.NesHeader.ROMSize << 1));
  W.ROMBANK2 = ROMPAGE((((Map232_Regs[0] | 0x03) << 1) + 0) %
                       (S.NesHeader.ROMSize << 1));
  W.ROMBANK3 = ROMPAGE((((Map232_Regs[0] | 0x03) << 1) + 1) %
                       (S.NesHeader.ROMSize << 1));
}
