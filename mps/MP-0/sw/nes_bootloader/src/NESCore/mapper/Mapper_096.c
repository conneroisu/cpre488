...
void Map96_Write(word wAddr, byte byData) {
  W.ROMBANK0 =
      ROMPAGE((((byData & 0x03) << 2) + 0) % (S.NesHeader.ROMSize << 1));
  W.ROMBANK1 =
      ROMPAGE((((byData & 0x03) << 2) + 1) % (S.NesHeader.ROMSize << 1));
  W.ROMBANK2 =
      ROMPAGE((((byData & 0x03) << 2) + 2) % (S.NesHeader.ROMSize << 1));
  W.ROMBANK3 =
      ROMPAGE((((byData & 0x03) << 2) + 3) % (S.NesHeader.ROMSize << 1));
