...
void Map236_Write(word wAddr, byte byData) {
  ...
  case 0x00:
    ...
    W.ROMBANK2 =
        ROMPAGE((((Map236_Bank | 0x07) << 1) + 0) % (S.NesHeader.ROMSize << 1));
    W.ROMBANK3 =
        ROMPAGE((((Map236_Bank | 0x07) << 1) + 1) % (S.NesHeader.ROMSize << 1));
    break;
  case 0x10:
    Map236_Bank |= 0x37;
    W.ROMBANK0 = ROMPAGE(((Map236_Bank << 1) + 0) % (S.NesHeader.ROMSize << 1));
  ...
  case 0x20:
    Map236_Bank |= 0x08;
    W.ROMBANK0 =
        ROMPAGE((((Map236_Bank & 0xFE) << 1) + 0) % (S.NesHeader.ROMSize << 1));
    W.ROMBANK1 =
        ROMPAGE((((Map236_Bank & 0xFE) << 1) + 1) % (S.NesHeader.ROMSize << 1));
    W.ROMBANK2 =
        ROMPAGE((((Map236_Bank & 0xFE) << 1) + 2) % (S.NesHeader.ROMSize << 1));
    W.ROMBANK3 =
        ROMPAGE((((Map236_Bank & 0xFE) << 1) + 3) % (S.NesHeader.ROMSize << 1));
    break;
  case 0x30:
    Map236_Bank |= 0x08;
    W.ROMBANK0 = ROMPAGE(((Map236_Bank << 1) + 0) % (S.NesHeader.ROMSize << 1));
