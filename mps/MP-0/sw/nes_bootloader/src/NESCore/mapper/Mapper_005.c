  ...
  if (MS5.Map5_Wram_Protect0 == 0x02 && MS5.Map5_Wram_Protect1 == 0x01) {
    ...
    case 0x8000: /* $8000-$9fff */
      if (MS5.Map5_Wram_Reg[4] != 0xff) {
        MS5.Map5_Wram[0x2000 * MS5.Map5_Wram_Reg[4] + (wAddr - 0x8000)] =
            byData;
      }
      break;
    ...
    case 0xa000: /* $a000-$bfff */
      if (MS5.Map5_Wram_Reg[5] != 0xff) {
        MS5.Map5_Wram[0x2000 * MS5.Map5_Wram_Reg[5] + (wAddr - 0xa000)] =
            byData;
      }
      break;
    ...
    case 0xc000: /* $c000-$dfff */
      if (MS5.Map5_Wram_Reg[6] != 0xff) {
        MS5.Map5_Wram[0x2000 * MS5.Map5_Wram_Reg[6] + (wAddr - 0xc000)] =
            byData;
      }
      break;
    }
...
void Map5_RenderScreen(byte byMode) {
  ...
  case 0:
    dwPage[7] =
        ((dword)MS5.Map5_Chr_Reg[7][byMode] << 3) % (S.NesHeader.VROMSize << 3);
  ...
  case 1:
    dwPage[3] =
        ((dword)MS5.Map5_Chr_Reg[3][byMode] << 2) % (S.NesHeader.VROMSize << 3);
    dwPage[7] =
        ((dword)MS5.Map5_Chr_Reg[7][byMode] << 2) % (S.NesHeader.VROMSize << 3);
  ...
  case 2:
    dwPage[1] =
        ((dword)MS5.Map5_Chr_Reg[1][byMode] << 1) % (S.NesHeader.VROMSize << 3);
    dwPage[3] =
        ((dword)MS5.Map5_Chr_Reg[3][byMode] << 1) % (S.NesHeader.VROMSize << 3);
    dwPage[5] =
        ((dword)MS5.Map5_Chr_Reg[5][byMode] << 1) % (S.NesHeader.VROMSize << 3);
    dwPage[7] =
        ((dword)MS5.Map5_Chr_Reg[7][byMode] << 1) % (S.NesHeader.VROMSize << 3);
  ...
  default:
    dwPage[0] =
        (dword)MS5.Map5_Chr_Reg[0][byMode] % (S.NesHeader.VROMSize << 3);
    dwPage[1] =
        (dword)MS5.Map5_Chr_Reg[1][byMode] % (S.NesHeader.VROMSize << 3);
    dwPage[2] =
        (dword)MS5.Map5_Chr_Reg[2][byMode] % (S.NesHeader.VROMSize << 3);
    dwPage[3] =
        (dword)MS5.Map5_Chr_Reg[3][byMode] % (S.NesHeader.VROMSize << 3);
    dwPage[4] =
        (dword)MS5.Map5_Chr_Reg[4][byMode] % (S.NesHeader.VROMSize << 3);
    dwPage[5] =
        (dword)MS5.Map5_Chr_Reg[5][byMode] % (S.NesHeader.VROMSize << 3);
    dwPage[6] =
        (dword)MS5.Map5_Chr_Reg[6][byMode] % (S.NesHeader.VROMSize << 3);
    dwPage[7] =
        (dword)MS5.Map5_Chr_Reg[7][byMode] % (S.NesHeader.VROMSize << 3);
...
void Map5_Sync_Prg_Banks(void) {
  ...
  case 0:
    ...
    W.ROMBANK0 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7c) + 0) %
                         (S.NesHeader.ROMSize << 1));
    W.ROMBANK1 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7c) + 1) %
                         (S.NesHeader.ROMSize << 1));
    W.ROMBANK2 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7c) + 2) %
                         (S.NesHeader.ROMSize << 1));
    W.ROMBANK3 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7c) + 3) %
                         (S.NesHeader.ROMSize << 1));
    break;
  ...
  case 1:
    if (MS5.Map5_Prg_Reg[5] & 0x80) {
      MS5.Map5_Wram_Reg[4] = 0xff;
      MS5.Map5_Wram_Reg[5] = 0xff;
      W.ROMBANK0 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7e) + 0) %
                           (S.NesHeader.ROMSize << 1));
      W.ROMBANK1 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7e) + 1) %
                           (S.NesHeader.ROMSize << 1));
    } else {
    ...
    MS5.Map5_Wram_Reg[6] = 0xff;
    W.ROMBANK2 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7e) + 0) %
                         (S.NesHeader.ROMSize << 1));
    W.ROMBANK3 = ROMPAGE(((MS5.Map5_Prg_Reg[7] & 0x7e) + 1) %
                         (S.NesHeader.ROMSize << 1));
    break;
  ...
  case 2:
    if (MS5.Map5_Prg_Reg[5] & 0x80) {
      MS5.Map5_Wram_Reg[4] = 0xff;
      MS5.Map5_Wram_Reg[5] = 0xff;
      W.ROMBANK0 = ROMPAGE(((MS5.Map5_Prg_Reg[5] & 0x7e) + 0) %
                           (S.NesHeader.ROMSize << 1));
      W.ROMBANK1 = ROMPAGE(((MS5.Map5_Prg_Reg[5] & 0x7e) + 1) %
                           (S.NesHeader.ROMSize << 1));
    } else {
      MS5.Map5_Wram_Reg[4] = (MS5.Map5_Prg_Reg[5] & 0x06) + 0;
      MS5.Map5_Wram_Reg[5] = (MS5.Map5_Prg_Reg[5] & 0x06) + 1;
    ...
    if (MS5.Map5_Prg_Reg[6] & 0x80) {
      MS5.Map5_Wram_Reg[6] = 0xff;
      W.ROMBANK2 =
          ROMPAGE((MS5.Map5_Prg_Reg[6] & 0x7f) % (S.NesHeader.ROMSize << 1));
    } else {
    ...
    W.ROMBANK3 =
        ROMPAGE((MS5.Map5_Prg_Reg[7] & 0x7f) % (S.NesHeader.ROMSize << 1));
    break;
  ...
  default:
    if (MS5.Map5_Prg_Reg[4] & 0x80) {
      MS5.Map5_Wram_Reg[4] = 0xff;
      W.ROMBANK0 =
          ROMPAGE((MS5.Map5_Prg_Reg[4] & 0x7f) % (S.NesHeader.ROMSize << 1));
    } else {
    ...
    if (MS5.Map5_Prg_Reg[5] & 0x80) {
      MS5.Map5_Wram_Reg[5] = 0xff;
      W.ROMBANK1 =
          ROMPAGE((MS5.Map5_Prg_Reg[5] & 0x7f) % (S.NesHeader.ROMSize << 1));
    } else {
...
void Map5_Restore() { Map5_Sync_Prg_Banks(); }
