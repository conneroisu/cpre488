...
#include "../../../src/lib/nes_bootloader/NESCore/Tables.h"
...
int Exec6502(M6502 *R, int RunCycles) {
  ...
  while (S.RunCycles > 0) {
    ...
    switch (I) {
#include "../../../src/lib/nes_bootloader/NESCore/Codes.h"
    }
  }
