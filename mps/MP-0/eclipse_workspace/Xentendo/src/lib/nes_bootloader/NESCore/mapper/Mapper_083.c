...
void Map83_Write(word wAddr, byte byData) {
  ...
  case 0xB1FF:
    ...
    W.ROMBANK2 = ROMPAGE((((byData & 0x30) | 0x0F) * 2 + 0) %
                         (S.NesHeader.ROMSize << 1));
    W.ROMBANK3 = ROMPAGE((((byData & 0x30) | 0x0F) * 2 + 1) %
                         (S.NesHeader.ROMSize << 1));
    break;
  ...
  case 0x8310:
    if ((Map83_Regs[1] & 0x30) == 0x30) {
      W.PPUBANK[0] =
          VROMPAGE((Map83_Chr_Bank ^ byData) % (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
    } else if ((Map83_Regs[1] & 0x30) == 0x10 ||
               (Map83_Regs[1] & 0x30) == 0x20) {
      W.PPUBANK[0] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 0) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[1] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 1) %
                              (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
    }
    break;
  ...
  case 0x8311:
    if ((Map83_Regs[1] & 0x30) == 0x30) {
      ...
      NESCore_Develop_Character_Data();
               ...
               (Map83_Regs[1] & 0x30) == 0x20) {
      W.PPUBANK[2] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 0) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[3] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 1) %
                              (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
    }
    break;
  ...
  case 0x8312:
    if ((Map83_Regs[1] & 0x30) == 0x30) {
      ...
      NESCore_Develop_Character_Data();
               ...
               (Map83_Regs[1] & 0x30) == 0x20) {
      W.PPUBANK[4] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 0) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[5] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 1) %
                              (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
    }
    break;
  ...
  case 0x8313:
    if ((Map83_Regs[1] & 0x30) == 0x30) {
      ...
      NESCore_Develop_Character_Data();
               ...
               (Map83_Regs[1] & 0x30) == 0x20) {
      W.PPUBANK[6] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 0) %
                              (S.NesHeader.VROMSize << 3));
      W.PPUBANK[7] = VROMPAGE((((Map83_Chr_Bank ^ byData) * 2) + 1) %
                              (S.NesHeader.VROMSize << 3));
      NESCore_Develop_Character_Data();
    }
    break;
  ...
  case 0x8318:
    W.ROMBANK0 = ROMPAGE((((Map83_Regs[0] & 0x30) | byData) * 2 + 0) %
                         (S.NesHeader.ROMSize << 1));
    W.ROMBANK1 = ROMPAGE((((Map83_Regs[0] & 0x30) | byData) * 2 + 1) %
                         (S.NesHeader.ROMSize << 1));
    break;
  }
}
