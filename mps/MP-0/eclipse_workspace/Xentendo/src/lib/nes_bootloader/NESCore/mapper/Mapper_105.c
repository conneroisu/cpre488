    ...
    if (Map105_Reg[1] & 0x08) {
      if (Map105_Reg[0] & 0x08) {
        if (Map105_Reg[0] & 0x04) {
          W.ROMBANK0 = ROMPAGE(((Map105_Reg[3] & 0x07) * 2 + 16) %
                               (S.NesHeader.ROMSize << 1));
          W.ROMBANK1 = ROMPAGE(((Map105_Reg[3] & 0x07) * 2 + 17) %
                               (S.NesHeader.ROMSize << 1));
          ...
          W.ROMBANK2 = ROMPAGE(((Map105_Reg[3] & 0x07) * 2 + 16) %
                               (S.NesHeader.ROMSize << 1));
          W.ROMBANK3 = ROMPAGE(((Map105_Reg[3] & 0x07) * 2 + 17) %
                               (S.NesHeader.ROMSize << 1));
        }
      } else {
        W.ROMBANK0 = ROMPAGE(((Map105_Reg[3] & 0x06) * 2 + 16) %
                             (S.NesHeader.ROMSize << 1));
        W.ROMBANK1 = ROMPAGE(((Map105_Reg[3] & 0x06) * 2 + 17) %
                             (S.NesHeader.ROMSize << 1));
        W.ROMBANK2 = ROMPAGE(((Map105_Reg[3] & 0x06) * 2 + 18) %
                             (S.NesHeader.ROMSize << 1));
        W.ROMBANK3 = ROMPAGE(((Map105_Reg[3] & 0x06) * 2 + 19) %
                             (S.NesHeader.ROMSize << 1));
      }
    } else {
      W.ROMBANK0 = ROMPAGE(((Map105_Reg[1] & 0x06) * 2 + 0) %
                           (S.NesHeader.ROMSize << 1));
      W.ROMBANK1 = ROMPAGE(((Map105_Reg[1] & 0x06) * 2 + 1) %
                           (S.NesHeader.ROMSize << 1));
      W.ROMBANK2 = ROMPAGE(((Map105_Reg[1] & 0x06) * 2 + 2) %
                           (S.NesHeader.ROMSize << 1));
      W.ROMBANK3 = ROMPAGE(((Map105_Reg[1] & 0x06) * 2 + 3) %
                           (S.NesHeader.ROMSize << 1));
    }
