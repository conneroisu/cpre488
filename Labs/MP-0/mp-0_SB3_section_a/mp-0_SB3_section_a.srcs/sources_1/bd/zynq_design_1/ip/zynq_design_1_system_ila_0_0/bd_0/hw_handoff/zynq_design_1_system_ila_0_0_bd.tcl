...
################################################################
# This is a generated script based on design: bd_c3fe
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXI:SLOT_3_AXI:SLOT_4_AXIS} \
...
connect_bd_intf_net -intf_net Conn4 [get_bd_intf_ports SLOT_4_AXIS] [get_bd_intf_pins g_inst/slot_4_axis]
  ...
  connect_bd_net -net SLOT_5_VIDEO_TIMING_active_video_1 [get_bd_ports SLOT_5_VIDEO_TIMING_active_video] [get_bd_pins ila_lib/probe89]
  connect_bd_net -net SLOT_5_VIDEO_TIMING_hblank_1 [get_bd_ports SLOT_5_VIDEO_TIMING_hblank] [get_bd_pins ila_lib/probe90]
  connect_bd_net -net SLOT_5_VIDEO_TIMING_hsync_1 [get_bd_ports SLOT_5_VIDEO_TIMING_hsync] [get_bd_pins ila_lib/probe91]
  connect_bd_net -net SLOT_5_VIDEO_TIMING_vblank_1 [get_bd_ports SLOT_5_VIDEO_TIMING_vblank] [get_bd_pins ila_lib/probe92]
  connect_bd_net -net SLOT_5_VIDEO_TIMING_vsync_1 [get_bd_ports SLOT_5_VIDEO_TIMING_vsync] [get_bd_pins ila_lib/probe93]
