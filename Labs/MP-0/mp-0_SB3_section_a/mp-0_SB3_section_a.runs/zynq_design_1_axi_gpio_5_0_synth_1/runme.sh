...
HD_PWD='C:/Users/jaxie963/temp/cpre488/Labs/MP-0/mp-0_SB3_section_a/mp-0_SB3_section_a.runs/zynq_design_1_axi_gpio_5_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_axi_gpio_5_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_axi_gpio_5_0.tcl
