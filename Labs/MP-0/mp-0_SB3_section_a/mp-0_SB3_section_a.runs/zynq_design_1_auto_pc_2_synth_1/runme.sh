...
HD_PWD='U:/cpre488/Labs/MP-0/mp-0_SB3_section_a/mp-0_SB3_section_a.runs/zynq_design_1_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_auto_pc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_auto_pc_2.tcl
