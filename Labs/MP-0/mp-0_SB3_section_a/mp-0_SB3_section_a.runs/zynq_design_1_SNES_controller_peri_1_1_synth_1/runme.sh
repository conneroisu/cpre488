...
HD_PWD='C:/Users/jaxie963/cpre488/Labs/MP-0/mp-0_SB3_section_a/mp-0_SB3_section_a.runs/zynq_design_1_SNES_controller_peri_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_SNES_controller_peri_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_SNES_controller_peri_1_1.tcl
