...
module bd_03cf
  ...
  bd_03cf_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe10(net_slot_0_axi_awlen),
        .probe100(net_slot_5_axi_aw_ctrl),
        .probe101(net_slot_5_axi_w_ctrl),
        .probe102(net_slot_5_axi_b_ctrl),
        .probe103(net_slot_5_axi_ar_ctrl),
        .probe104(net_slot_5_axi_r_ctrl),
        ...
        .probe65(net_slot_3_axi_arprot),
        .probe66(net_slot_3_axi_aw_cnt),
        .probe67(net_slot_3_axi_awaddr),
        .probe68(net_slot_3_axi_awprot),
        .probe69(net_slot_3_axi_b_cnt),
        .probe7(net_slot_0_axi_aw_cnt),
        .probe70(net_slot_3_axi_bresp),
        .probe71(net_slot_3_axi_r_cnt),
        .probe72(net_slot_3_axi_rdata),
        .probe73(net_slot_3_axi_rresp),
        .probe74(net_slot_3_axi_wdata),
        .probe75(net_slot_3_axi_wstrb),
        .probe76(net_slot_3_axi_aw_ctrl),
        .probe77(net_slot_3_axi_w_ctrl),
        .probe78(net_slot_3_axi_b_ctrl),
        .probe79(net_slot_3_axi_ar_ctrl),
        .probe8(net_slot_0_axi_awaddr),
        .probe80(net_slot_3_axi_r_ctrl),
        .probe81(net_slot_4_axis_tdata),
        .probe82(net_slot_4_axis_tkeep),
        .probe83(net_slot_4_axis_tuser),
        .probe84(net_slot_4_axis_tvalid),
        .probe85(net_slot_4_axis_tready),
        .probe86(net_slot_4_axis_tlast),
        .probe87(net_slot_5_axi_ar_cnt),
        .probe88(net_slot_5_axi_araddr),
        .probe89(net_slot_5_axi_arprot),
        .probe9(net_slot_0_axi_awcache),
        .probe90(net_slot_5_axi_aw_cnt),
        .probe91(net_slot_5_axi_awaddr),
        .probe92(net_slot_5_axi_awprot),
        .probe93(net_slot_5_axi_b_cnt),
        .probe94(net_slot_5_axi_bresp),
        .probe95(net_slot_5_axi_r_cnt),
        .probe96(net_slot_5_axi_rdata),
        .probe97(net_slot_5_axi_rresp),
        .probe98(net_slot_5_axi_wdata),
        .probe99(net_slot_5_axi_wstrb));
