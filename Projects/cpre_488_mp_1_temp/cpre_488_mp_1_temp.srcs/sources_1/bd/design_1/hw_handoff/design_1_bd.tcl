...
proc create_root_design { parentCell } {
  ...
  set PMOD_Output [ create_bd_port -dir O PMOD_Output ]
  ...
  connect_bd_net -net PMOD_Input_1 [get_bd_ports PMOD_Input] [get_bd_pins PPM_0/PPM_Input]
  connect_bd_net -net PPM_0_PPM_Output [get_bd_ports PMOD_Output] [get_bd_pins PPM_0/PPM_Output]
