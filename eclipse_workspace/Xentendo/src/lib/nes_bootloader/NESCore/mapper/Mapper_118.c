  ...
  case 0x8001:
    ...
    case 0x00:
      if (S.NesHeader.VROMSize > 0) {
        ...
        if (Map118_Chr_Swap()) {
          W.PPUBANK[4] =
              VROMPAGE((MS118.Map118_PPU[0]) % (S.NesHeader.VROMSize << 3));
          W.PPUBANK[5] =
              VROMPAGE((MS118.Map118_PPU[0] + 1) % (S.NesHeader.VROMSize << 3));
        } else {
          W.PPUBANK[0] =
              VROMPAGE((MS118.Map118_PPU[0]) % (S.NesHeader.VROMSize << 3));
          W.PPUBANK[1] =
    ...
    case 0x01:
      if (S.NesHeader.VROMSize > 0) {
        ...
        if (Map118_Chr_Swap()) {
          W.PPUBANK[6] =
              VROMPAGE((MS118.Map118_PPU[1]) % (S.NesHeader.VROMSize << 3));
          W.PPUBANK[7] =
              VROMPAGE((MS118.Map118_PPU[1] + 1) % (S.NesHeader.VROMSize << 3));
        } else {
          W.PPUBANK[2] =
              VROMPAGE((MS118.Map118_PPU[1]) % (S.NesHeader.VROMSize << 3));
          W.PPUBANK[3] =
    ...
    case 0x02:
      if (S.NesHeader.VROMSize > 0) {
        ...
        if (Map118_Chr_Swap()) {
          W.PPUBANK[0] =
              VROMPAGE(MS118.Map118_PPU[2] % (S.NesHeader.VROMSize << 3));
        } else {
          W.PPUBANK[4] =
              VROMPAGE(MS118.Map118_PPU[2] % (S.NesHeader.VROMSize << 3));
        }
    ...
    case 0x03:
      if (S.NesHeader.VROMSize > 0) {
        ...
        if (Map118_Chr_Swap()) {
          W.PPUBANK[1] =
              VROMPAGE(MS118.Map118_PPU[3] % (S.NesHeader.VROMSize << 3));
        } else {
          W.PPUBANK[5] =
              VROMPAGE(MS118.Map118_PPU[3] % (S.NesHeader.VROMSize << 3));
        }
    ...
    case 0x04:
      if (S.NesHeader.VROMSize > 0) {
        ...
        if (Map118_Chr_Swap()) {
          W.PPUBANK[2] =
              VROMPAGE(MS118.Map118_PPU[4] % (S.NesHeader.VROMSize << 3));
        } else {
          W.PPUBANK[6] =
              VROMPAGE(MS118.Map118_PPU[4] % (S.NesHeader.VROMSize << 3));
        }
    ...
    case 0x05:
      if (S.NesHeader.VROMSize > 0) {
        ...
        if (Map118_Chr_Swap()) {
          W.PPUBANK[3] =
              VROMPAGE(MS118.Map118_PPU[5] % (S.NesHeader.VROMSize << 3));
        } else {
          W.PPUBANK[7] =
              VROMPAGE(MS118.Map118_PPU[5] % (S.NesHeader.VROMSize << 3));
        }
...
void Map118_HSync() {
  ...
  if (S.PPU_Scanline < 240 &&
      ((S.PPU_R1 & R1_SHOW_SCR) || (S.PPU_R1 & R1_SHOW_SP))) {
    if (MS118.Map118_IRQ_Counter != 0) {
      MS118.Map118_IRQ_Counter--;
    } else {
      MS118.Map118_IRQ_Counter = MS118.Map118_IRQ_Latch;
    }
    if ((oldCounter > 0) && (MS118.Map118_IRQ_Counter == 0) &&
        (MS118.Map118_IRQ_Enabled)) {
      IRQ_REQ;
    }
  }
}
...
void Map118_Restore() { Map118_Set_PPU_Banks(); }
