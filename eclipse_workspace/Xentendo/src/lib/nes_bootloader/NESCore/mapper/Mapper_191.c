...
void Map191_Set_PPU_Banks() {
  if (S.NesHeader.VROMSize > 0) {
    W.PPUBANK[0] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr0) << 2) + 0) %
                 (S.NesHeader.VROMSize << 3));
    W.PPUBANK[1] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr0) << 2) + 1) %
                 (S.NesHeader.VROMSize << 3));
    W.PPUBANK[2] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr1) << 2) + 2) %
                 (S.NesHeader.VROMSize << 3));
    W.PPUBANK[3] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr1) << 2) + 3) %
                 (S.NesHeader.VROMSize << 3));
    W.PPUBANK[4] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr2) << 2) + 0) %
                 (S.NesHeader.VROMSize << 3));
    W.PPUBANK[5] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr2) << 2) + 1) %
                 (S.NesHeader.VROMSize << 3));
    W.PPUBANK[6] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr3) << 2) + 2) %
                 (S.NesHeader.VROMSize << 3));
    W.PPUBANK[7] =
        VROMPAGE(((((Map191_Highbank << 3) + Map191_Chr3) << 2) + 3) %
                 (S.NesHeader.VROMSize << 3));
